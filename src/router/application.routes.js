...
applicationRouter.get('/', checkToken, roleGuard('admin'), pagination, getAllApplicationController)
applicationRouter.get('/:id', checkToken, getByIdApplicationController)
applicationRouter.post('/create', checkToken, validationMiddleware(applicationSchema), createApplicationController)
